...
object CryptoUtils {
    ...
    suspend fun encrypt(plaintext: String, pubKeyBase64: String): String = withContext(Dispatchers.Default) {
    ...
    suspend fun decrypt(ciphertextBase64: String, privKeyBase64: String): String = withContext(Dispatchers.Default) {
